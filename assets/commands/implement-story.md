...
5. Follow the **Implementation Order** section for sequencing. When Section 8a contains `parity` rows, those characterization tests are the first failing tests.

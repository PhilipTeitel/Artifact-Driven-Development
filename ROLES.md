...
- **Commands.** `/review-story`, `/review-diff`, `/map-repo`, `/audit-all`, `/triage-audit-findings`, and the seven category audits.
...
| Post-complete follow-up ledger entry | Implementer (via `/patch-story`) |
